...
void setup_scr_screen_audio_Tag(lv_ui *ui)
{
    ...
    lv_image_set_src(ui->screen_audio_Tag_img_bg, &_markbg_RGB565_240x280_tresh);
    ...
    lv_image_set_src(ui->screen_audio_Tag_img_audio_playing, &_voc_RGB565A8_55x55);
    ...
    lv_image_set_src(ui->screen_audio_Tag_img_audio_play, &_voc2_RGB565A8_55x55);
