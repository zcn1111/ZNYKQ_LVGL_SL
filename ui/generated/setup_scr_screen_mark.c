...
void setup_scr_screen_mark(lv_ui *ui)
{
    ...
    lv_image_set_src(ui->screen_mark_img_bg, &_biaoji_RGB565_240x280_tresh);
    ...
    lv_obj_set_size(ui->screen_mark_btn_overlimt, 72, 40);
    ...
    lv_obj_set_size(ui->screen_mark_btn_mark, 72, 40);
    ...
    lv_obj_set_size(ui->screen_mark_btn_audio, 72, 40);
