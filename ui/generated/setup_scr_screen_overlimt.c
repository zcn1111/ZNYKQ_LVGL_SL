...
void setup_scr_screen_overlimt(lv_ui *ui)
{
    ...
    lv_image_set_src(ui->screen_overlimt_img_bg, &_chaoxian_RGB565_240x280_tresh);
    ...
    lv_obj_set_size(ui->screen_overlimt_btn_overlimt, 72, 40);
    ...
    lv_obj_set_size(ui->screen_overlimt_btn_mark, 72, 40);
    ...
    lv_obj_set_size(ui->screen_overlimt_btn_audiomark, 72, 40);
