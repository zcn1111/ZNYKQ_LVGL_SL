...
void setup_scr_screen_set(lv_ui *ui)
{
    ...
    lv_image_set_src(ui->screen_set_img_bg, &_bg_RGB565A8_240x280);
    ...
    lv_obj_set_pos(ui->screen_set_cont_6, 5, 56);
    lv_obj_set_size(ui->screen_set_cont_6, 228, 207);
    ...
    lv_obj_set_pos(ui->screen_set_cont_7, 5, 5);
    ...
    lv_obj_set_style_bg_opa(ui->screen_set_cont_7, 35, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_image_set_src(ui->screen_set_img_1, &_ly_RGB565A8_30x30);
    ...
    lv_obj_set_pos(ui->screen_set_cont_8, 5, 125);
    ...
    lv_obj_set_style_bg_opa(ui->screen_set_cont_8, 35, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_image_set_src(ui->screen_set_img_2, &_a12_RGB565A8_30x30);
    ...
    lv_obj_set_pos(ui->screen_set_cont_9, 5, 65);
    ...
    lv_obj_set_style_bg_opa(ui->screen_set_cont_9, 35, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_image_set_src(ui->screen_set_img_3, &_voic_RGB565A8_30x30);
