...
void setup_scr_screen_record(lv_ui *ui)
{
    ...
    //Write codes screen_record_img_1
    ui->screen_record_img_1 = lv_image_create(ui->screen_record);
    lv_obj_set_pos(ui->screen_record_img_1, 0, 0);
    lv_obj_set_size(ui->screen_record_img_1, 240, 280);
    lv_obj_add_flag(ui->screen_record_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_record_img_1, &_bg_RGB565A8_240x280);
    lv_image_set_pivot(ui->screen_record_img_1, 50,50);
    lv_image_set_rotation(ui->screen_record_img_1, 0);

    //Write style for screen_record_img_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_record_img_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_record_img_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->screen_record_animimg_2, 209, 81);
    lv_animimg_set_src(ui->screen_record_animimg_2, (const void **) screen_record_animimg_2_imgs, 20, false);
    lv_animimg_set_duration(ui->screen_record_animimg_2, 80*20);
