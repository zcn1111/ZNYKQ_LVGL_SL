...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->screen_mileage_reminder_del = true;
    ui->screen_set_del = true;
    ui->screen_log_del = true;
    ui->screen_overlimt_del = true;
    ui->screen_mark_del = true;
    ui->screen_audiomark_del = true;
    ui->screen_about_del = true;
    ui->screen_Tag_del = true;
    ui->screen_audio_Tag_del = true;
    ui->screen_mark_err_del = true;
    ui->screen_warn1_del = true;
    ui->screen_warn2_del = true;
    ui->screen_warn3_del = true;
    ui->screen_warn4_del = true;
...
void setup_ui(lv_ui *ui)
{
    ...
    init_keyboard(ui);
    setup_scr_screen_log(ui);
    lv_screen_load(ui->screen_log);
}
