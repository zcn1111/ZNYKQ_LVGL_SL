...
void setup_scr_screen_Tag(lv_ui *ui)
{
    ...
    //Write codes screen_Tag_label_type1
    ui->screen_Tag_label_type1 = lv_label_create(ui->screen_Tag);
    lv_obj_set_pos(ui->screen_Tag_label_type1, 34, 49);
    lv_obj_set_size(ui->screen_Tag_label_type1, 104, 27);
    lv_label_set_text(ui->screen_Tag_label_type1, "人工标记");
    lv_label_set_long_mode(ui->screen_Tag_label_type1, LV_LABEL_LONG_WRAP);

    //Write style for screen_Tag_label_type1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_Tag_label_type1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_Tag_label_type1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_Tag_label_type1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_Tag_label_type1, &lv_font_PingFangHeavy_26, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_Tag_label_type1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_Tag_label_type1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_Tag_label_type1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_Tag_label_type1, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_Tag_label_type1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_Tag_label_type1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_Tag_label_type1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_Tag_label_type1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_Tag_label_type1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_Tag_label_type1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_Tag_label_speed, 34, 168);
    ...
    lv_obj_set_pos(ui->screen_Tag_label_linenum_mileage, 34, 132);
    ...
    //Write codes screen_Tag_label_tip
    ui->screen_Tag_label_tip = lv_label_create(ui->screen_Tag);
    lv_obj_set_pos(ui->screen_Tag_label_tip, 38, 7);
    lv_obj_set_size(ui->screen_Tag_label_tip, 168, 21);
    lv_obj_add_flag(ui->screen_Tag_label_tip, LV_OBJ_FLAG_HIDDEN);
    lv_label_set_text(ui->screen_Tag_label_tip, "录音标记中...");
    lv_label_set_long_mode(ui->screen_Tag_label_tip, LV_LABEL_LONG_WRAP);

    //Write style for screen_Tag_label_tip, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_Tag_label_tip, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_Tag_label_tip, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_Tag_label_tip, lv_color_hex(0xfbfd46), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_Tag_label_tip, &lv_font_PingFangHeavy_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_Tag_label_tip, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_Tag_label_tip, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_Tag_label_tip, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_Tag_label_tip, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_Tag_label_tip, 75, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_Tag_label_tip, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_Tag_label_tip, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_Tag_label_tip, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_Tag_label_tip, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_Tag_label_tip, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_Tag_label_tip, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_Tag_label_tip, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_Tag_label_type
    ui->screen_Tag_label_type = lv_label_create(ui->screen_Tag);
    lv_obj_set_pos(ui->screen_Tag_label_type, 34, 98);
    lv_obj_set_size(ui->screen_Tag_label_type, 182, 24);
    lv_label_set_text(ui->screen_Tag_label_type, "类型: 晃车");
    ...
    lv_obj_set_style_text_font(ui->screen_Tag_label_type, &lv_font_PingFangHeavy_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->screen_Tag_label_type, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
