...
void setup_scr_screen_about(lv_ui *ui)
{
    ...
    lv_image_set_src(ui->screen_about_img_bg, &_bg_RGB565A8_240x280);
    ...
    lv_obj_set_style_text_font(ui->screen_about_label_hardnum, &lv_font_PingFangHeavy_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_about_label_softnum, &lv_font_PingFangHeavy_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_about_label_devnum, &lv_font_PingFangHeavy_20, LV_PART_MAIN|LV_STATE_DEFAULT);
