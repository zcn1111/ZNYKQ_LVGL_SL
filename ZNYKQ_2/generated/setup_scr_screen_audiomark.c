...
void setup_scr_screen_audiomark(lv_ui *ui)
{
    ...
    lv_image_set_src(ui->screen_audiomark_img_bg, &_luyingbg_RGB565A8_240x280);
    ...
    lv_obj_set_size(ui->screen_audiomark_btn_overlimt, 72, 34);
    ...
    lv_obj_set_size(ui->screen_audiomark_btn_mark, 72, 34);
    ...
    lv_obj_set_size(ui->screen_audiomark_btn_audio, 72, 34);
